...
namespace Crownsfall.Editor
{
    ...
    {
        private const string PrefabPath = "Assets/Prefabs/UI/FloatingCombatText.prefab";

        [MenuItem("Tools/Fighter Tools/Create Floating Combat Text Prefab")]
        public static void CreateFloatingCombatTextPrefab()
        {
            ...
            tmp.color = new Color(1f, 0.267f, 0.267f, 1f);
